...
if (isset($_POST['p3pl'])) {
    ...
    // menyiapkan query
    $sql = "INSERT INTO tb_p3pl (judul, link) 
            VALUES (:judul, :link)";
    $stmt = $db->prepare($sql);
    ...
    if ($saved) header("Location:p3pl.php");
}
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="" method="POST">
                    ...
                    <input type="submit" class="btn btn-success btn-block" name="p3pl" value="Save" />
