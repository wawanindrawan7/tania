...
if (isset($_POST['sdk'])) {
    ...
    // menyiapkan query
    $sql = "INSERT INTO tb_sdk (judul, link) 
            VALUES (:judul, :link)";
    $stmt = $db->prepare($sql);
    ...
    if ($saved) header("Location: sdk.php");
}
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="" method="POST">
                    ...
                    <input type="submit" class="btn btn-success btn-block" name="sdk" value="Save" />
