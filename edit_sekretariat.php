...
if (isset($_POST['update'])) {
    ...
    if (empty($judul) || empty($link)) {
        ...
        //updating the table
        $sql = "UPDATE tb_sekretariat SET judul=:judul, link=:link WHERE no=:no";
...
$sql = "SELECT * FROM tb_sekretariat WHERE no=:no";
$query = $db->prepare($sql);
    ...
    <div class="container">
        ...
        <div class="card mt-3">
            <div class="card-header">
                <h3>Edit Sekretariat</h3>
            </div>
            <div class="card-body">
                <form name="form1" method="post" action="edit_sekretariat.php">
