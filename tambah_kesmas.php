...
if (isset($_POST['kesmas'])) {
    ...
    // menyiapkan query
    $sql = "INSERT INTO tb_kesmas (judul, link) 
            VALUES (:judul, :link)";
    $stmt = $db->prepare($sql);
    ...
    if ($saved) header("Location: kesmas.php");
}
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="" method="POST">
                    ...
                    <input type="submit" class="btn btn-success btn-block" name="kesmas" value="Save" />
