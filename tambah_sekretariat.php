...
if (isset($_POST['sekretariat'])) {
    ...
    // menyiapkan query
    $sql = "INSERT INTO tb_sekretariat (judul, link) 
            VALUES (:judul, :link)";
    $stmt = $db->prepare($sql);
    ...
    if ($saved) header("Location: sekretariat.php");
}
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="" method="POST">
                    ...
                    <input type="submit" class="btn btn-success btn-block" name="sekretariat" value="Save" />
